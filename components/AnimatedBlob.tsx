	...
	return (
		<>
			...
			{section === "hero2" && (
				<svg
					xmlns="http://www.w3.org/2000/svg"
					className="-z-50 left-[10%] top-[50%] -translate-y-1/2 absolute w-[90%] h-auto"
					viewBox="0 0 100 100">
					<defs>
						<linearGradient id="fill" x1="0%" y1="0%" x2="100%" y2="0%" gradientTransform="rotate(45 0.5 0.5)">
							...
							<stop
								offset="100%"
								stop-color={theme === "light-theme" ? "rgba(240, 240, 240, 0.80)" : "rgba(100, 255, 218, 0.05)"}
							/>
						</linearGradient>
					</defs>
					<path
				...
				<svg
					...
					<defs>
						<linearGradient id="fill" x1="0%" y1="0%" x2="100%" y2="0%" gradientTransform="rotate(54 0.5 0.5)">
							...
							<stop offset="100%" stop-color="#fefeee" />
						</linearGradient>
					</defs>
					<path
