...
const SpaceInvaders = () => {
		...
		for (let i = 0; i < alienArray.length; i++) {
			...
			if (alien.alive) {
				...
				if (alien.y >= ship.y) {
					...
					context.fillText("Press Enter to retry", 170, 20);
				}
			}
		}
	...
	function moveShip(e: KeyboardEvent) {
		if (gameOver) return;
	...
	return (
		<div className="font-gameFont p-0 sm:p-4">
			<div className="mx-auto w-max">
				<h3 className="text-center text-3xl py-2">Space Invaders</h3>
				<canvas id="space-invaders-board" className="bg-black"></canvas>
			</div>
			<p className="mt-4 py-5 text-xl text-center">
				Controls — Tap Enter to shoot and press left/right arrow keys to move.
				<br />
				<br />
				Note - Only for PC
			</p>
